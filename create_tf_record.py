...
flags = tf.app.flags
flags.DEFINE_string('data_dir', 'dataset', 'Root directory to raw pet dataset.')
flags.DEFINE_string('output_dir', 'dataset', 'Path to directory to output TFRecords.')
flags.DEFINE_string('label_map_path', 'dataset/object_detection.pbtxt',
